...
export default function OrderTrackingTable({ orders, onRefresh }: OrderTrackingTableProps) {
    ...
    const handleCancelOrder = async (order: Order) => {
        ...
        dispatch(SliceGlobalModal.actions.openModal({
            modalType: "warning",
            message: `${order.orderId} numaralı emri iptal etmek istediğinizden emin misiniz?`,
        ...
        <div className="p-6 bg-white ">
            <div className="flex items-center justify-between mb-6">
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-md transition-all ${isRefreshing
                            ...
                            <td className="p-2">
                                {!isCancelDisabled(order) ? (
                                    <button
                                        ...
                                        className={`${cancellingOrderId === order.orderId
